# PyAlgoTrade
# tick DataSeries encapsulation
# @author xuefu@pyalgoteam.sdu
#calls the bar.Ticks in the same directory
...
class TickDataSeries(dataseries.SequenceDataSeries):
    ...
    def __init__(self, maxLen=None):
        ...
        self.__boughtAmountDS = dataseries.SequenceDataSeries(maxLen)
        self.__soldAmountDS = dataseries.SequenceDataSeries(maxLen)
        self.__boughtVolumeDS = dataseries.SequenceDataSeries(maxLen)
        self.__soldVolumeDS = dataseries.SequenceDataSeries(maxLen)
    ...
    def appendWithDateTime(self, dateTime, bar):
        ...
        self.__boughtAmountDS.appendWithDateTime(dateTime, bar.getBoughtAmount())
        self.__boughtVolumeDS.appendWithDateTime(dateTime, bar.getBoughtVolume())
    ...
    def getBoughtAmountSeries(self):
        """Returns a :class:`pyalgotrade.dataseries.DataSeries` with the close prices."""
        return self.__boughtAmountDS

    def getBoughtVolumeDataSeries(self):
        """Returns a :class:`pyalgotrade.dataseries.DataSeries` with the high prices."""
        return self.__boughtVolumeDS

    def getSoldAmountDataSeries(self):
        """Returns a :class:`pyalgotrade.dataseries.DataSeries` with the low prices."""
        return self.__soldAmountDS

    def getSoldVolumeDataSeries(self):
        """Returns a :class:`pyalgotrade.dataseries.DataSeries` with the volume."""
        return self.__soldVolumeDS
