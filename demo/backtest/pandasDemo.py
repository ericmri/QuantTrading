...
def turtle_test(loadtype='tushare', dataString='pyalg'):
    ...
    if loadtype == 'tushare':
        ...
        dat = pd.read_csv("/Users/Eric.xu/PycharmProjects/xuefu/api/stock/csv/600848.csv", index_col=0)
        print (dat.head())
    feed = dataFramefeed.Feed()
    feed.addBarsFromDataFrame("600848", dat)
    myStrategy = pdr.turtle(feed, "600848", 20, 10)
